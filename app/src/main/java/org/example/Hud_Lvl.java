...
// Class: Hud_Lvl - in-game HUD, vacuum bar, health bar, score ve timer içerir.
...
public class Hud_Lvl extends Hud {
    ...
    // Vacuum bar, health bar, score ve timer label'larını oluşturur.
    ...
    // Health, vacuum, score ve timer'ı güncel değerlerle update eder.
    ...
    // Fill rectangle'ın yüksekliğini mevcut orana göre günceller.
    ...
    // Bar container rectangle'ı oluşturur.
    ...
    // Bar fill rectangle'ı oluşturur.
