...
public class GameConfig {
    //made these data variables public so we can access them directly
            ...
            while (reader.hasNextLine()) {
                ...
                switch (key) {
                    ...
                    case "entity_damage":
                        ...
                        break;
                    case "vacuum_decrease":
                        config.vacuumDecrease = value;
                        break;
                    case "vacuum_increase":
                        config.vacuumIncrease = value;
                        break;

                    case "level_1_playable_area_x":
                        config.level1PlayableAreaX = value;
                        break;
                    case "level_1_playable_area_y":
                        config.level1PlayableAreaY = value;
                        break;
                    case "level_1_playable_area_width":
                        config.level1PlayableAreaWidth = value;
                        break;
                    case "level_1_playable_area_height":
                    ...
                    case "level_2_playable_area_x":
                        config.level2PlayableAreaX = value;
                        break;
                    case "level_2_playable_area_y":
                        config.level2PlayableAreaY = value;
                        break;
                    case "level_2_playable_area_width":
                        config.level2PlayableAreaWidth = value;
                        break;
                    case "level_2_playable_area_height":
                    ...
                    case "level_3_playable_area_x":
                        config.level3PlayableAreaX = value;
                        break;
                    case "level_3_playable_area_y":
                        config.level3PlayableAreaY = value;
                        break;
                    case "level_3_playable_area_width":
                        config.level3PlayableAreaWidth = value;
                        break;
                    case "level_3_playable_area_height":
                    ...
                    case "health_token_increase":
                        config.healthTokenIncrease = value;
                        break;
                    case "vacuum_token_increase":
                        config.vacuumTokenIncrease = value;
                        break;
                    case "eye_token_duration":
