...
// Class: Token_Health - player health'ini artıran token.
...
public class Token_Health extends Token {
    ...
    // Health token'ın görselini oluşturur (yeşil artı işareti).
